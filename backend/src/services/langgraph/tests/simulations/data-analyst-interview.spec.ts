/**
 * End-to-End Test: Data Analyst Technical Interview with Priya Patel
 * 
 * Tests the "Data Analyst Technical Interview" simulation with up to 50 conversation turns.
 * Evaluates technical competence, SQL reasoning, and analytical communication.
...
describe('Data Analyst Technical Interview Simulation (Priya Patel)', () => {
  // Global setup - start server once
  beforeAll(async () => {
    console.log('\n' + '═'.repeat(80));
    console.log('🚀 DATA ANALYST INTERVIEW TEST SUITE - SETUP');
  ...
  afterAll(async () => {
    console.log('\n' + '═'.repeat(80));
    console.log('🧹 DATA ANALYST INTERVIEW TEST SUITE - CLEANUP');
    console.log('═'.repeat(80));
  ...
  test('should complete data analyst interview and achieve all goals', async () => {
    console.log('\n\n');
    console.log('╔' + '═'.repeat(78) + '╗');
    console.log('║' + ' Data Analyst Technical Interview - All Goals'.padEnd(78) + '║');
    console.log('╚' + '═'.repeat(78) + '╝');
    
    // Load simulation details
    const simulation = await loadSimulationBySlug('data-analyst-technical-interview-priya');
    ...
    console.log('\n✅ Data Analyst Interview simulation test completed successfully');
  }, TEST_TIMEOUT);
});
