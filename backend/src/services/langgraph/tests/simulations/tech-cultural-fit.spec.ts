/**
 * End-to-End Test: Technical & Cultural Fit Interview with Alex Chen
 * 
 * Tests the "The Technical & Cultural Fit Interview" simulation with up to 50 conversation turns.
 * Evaluates enthusiasm, technical discussion, and cultural alignment.
...
describe('Technical & Cultural Fit Interview Simulation (Alex Chen)', () => {
  // Global setup - start server once
  beforeAll(async () => {
    console.log('\n' + '═'.repeat(80));
    console.log('🚀 TECH & CULTURAL FIT INTERVIEW TEST SUITE - SETUP');
  ...
  afterAll(async () => {
    console.log('\n' + '═'.repeat(80));
    console.log('🧹 TECH & CULTURAL FIT INTERVIEW TEST SUITE - CLEANUP');
    console.log('═'.repeat(80));
  ...
  test('should complete tech & cultural fit interview and achieve all goals', async () => {
    console.log('\n\n');
    console.log('╔' + '═'.repeat(78) + '╗');
    console.log('║' + ' Tech & Cultural Fit Interview - All Goals'.padEnd(78) + '║');
    console.log('╚' + '═'.repeat(78) + '╝');
    
    // Load simulation details
    const simulation = await loadSimulationBySlug('tech-cultural-interview-alex');
