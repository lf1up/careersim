/**
 * End-to-End Test: Pitching Your Idea to David Miller
 * 
 * Tests the "Pitching Your Idea" simulation with up to 50 conversation turns.
 * Evaluates persuasion, data-driven arguments, and stakeholder management.
...
describe('Pitching Your Idea Simulation (David Miller)', () => {
  // Global setup - start server once
  beforeAll(async () => {
    console.log('\n' + '═'.repeat(80));
    console.log('🚀 PITCHING YOUR IDEA TEST SUITE - SETUP');
  ...
  afterAll(async () => {
    console.log('\n' + '═'.repeat(80));
    console.log('🧹 PITCHING YOUR IDEA TEST SUITE - CLEANUP');
    console.log('═'.repeat(80));
  ...
  test('should complete idea pitching conversation and achieve all goals', async () => {
    console.log('\n\n');
    console.log('╔' + '═'.repeat(78) + '╗');
    console.log('║' + ' Pitching Your Idea - All Goals'.padEnd(78) + '║');
    console.log('╚' + '═'.repeat(78) + '╝');
    
    // Load simulation details
    const simulation = await loadSimulationBySlug('pitching-idea-david');
    ...
    console.log('\n✅ Pitching Your Idea simulation test completed successfully');
  }, TEST_TIMEOUT);
});
