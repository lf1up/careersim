          ...
          <div className="hidden sm:flex sm:items-center">
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="px-3 py-2 text-sm font-semibold border-2 border-black dark:border-retro-ink-dark bg-white dark:bg-retro-surface-dark shadow-retro-2 dark:shadow-retro-dark-2 hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-retro-1 dark:hover:shadow-retro-dark-1 transition-transform text-retro-ink dark:text-retro-ink-dark"
              >
                Sign out
              </button>
            </div>
