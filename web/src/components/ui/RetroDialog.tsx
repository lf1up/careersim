  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      >
        <div
          className={clsx(
            'retro-card w-full max-w-lg max-h-[90vh] overflow-y-auto',
            className,
          )}
          role="dialog"
          aria-modal="true"
...
export const RetroTabs: React.FC<RetroTabsProps> = ({
  ...
  return (
    <div className={clsx('retro-card', className)}>
      <div
        className="px-4 py-2 border-b-2 border-black dark:border-retro-ink-dark flex gap-2 overflow-x-auto"
        role="tablist"
        onKeyDown={onKeyDown}
      >
        {tabs.map((t) => (
