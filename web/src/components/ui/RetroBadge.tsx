...
const colorMap: Record<NonNullable<RetroBadgeProps['color']>, string> = {
  default:
    'border-black dark:border-retro-ink-dark bg-white dark:bg-retro-surface-dark text-retro-ink dark:text-retro-ink-dark',
  yellow:
    'border-black dark:border-retro-ink-dark bg-yellow-300 dark:bg-yellow-500 text-black',
  cyan: 'border-black dark:border-retro-ink-dark bg-cyan-300 dark:bg-cyan-500 text-black',
  green:
    'border-black dark:border-retro-ink-dark bg-green-300 dark:bg-green-500 text-black',
  ...
  purple:
    'border-black dark:border-retro-ink-dark bg-purple-300 dark:bg-purple-500 text-black dark:text-white',
  orange:
    'border-black dark:border-retro-ink-dark bg-orange-300 dark:bg-orange-500 text-black',
  ...
  indigo:
    'border-black dark:border-retro-ink-dark bg-indigo-300 dark:bg-indigo-500 text-black dark:text-white',
  amber:
    'border-black dark:border-retro-ink-dark bg-amber-300 dark:bg-amber-500 text-black',
...
export const RetroBadge: React.FC<RetroBadgeProps> = ({
  ...
  return (
    <span
      className={clsx(
        'inline-flex items-center px-2.5 py-0.5 text-xs font-semibold border-2 shadow-retro-2 dark:shadow-retro-dark-2',
        colorMap[color],
        className,
      )}
    >
...
const toneMap: Record<NonNullable<RetroAlertProps['tone']>, string> = {
  ...
  warning:
    'bg-yellow-100 dark:bg-yellow-900 border-yellow-400 dark:border-yellow-600 text-yellow-900 dark:text-yellow-100',
  error:
...
export const RetroAlert: React.FC<RetroAlertProps> = ({
  ...
  return (
    <div
      className={clsx(
        'border-2 border-black dark:border-retro-ink-dark p-4 shadow-retro-4 dark:shadow-retro-dark-4',
        toneMap[tone],
        className,
      )}
    >
