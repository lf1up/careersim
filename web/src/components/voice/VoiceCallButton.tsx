 ...
 * accent and a phone glyph signal that a real-time voice call is
 * available — most users never expect that on a chat page, so the
 * button has to advertise itself.
 */
