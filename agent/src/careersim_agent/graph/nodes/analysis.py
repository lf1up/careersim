...
def analyze_user_input(state: ConversationState) -> dict[str, Any]:
    ...
    Uses local HuggingFace transformers for analysis.
    """
    ...
    try:
        ...
        sentiment_result = service.analyze_sentiment(last_user_message)
        emotion_result = service.analyze_emotion(last_user_message)
        ...
        trace = _add_trace(
            ...
            f"sentiment={sentiment_result['sentiment']}, emotion={emotion_result['emotion']}"
        )
...
def analyze_ai_response(state: ConversationState) -> dict[str, Any]:
    ...
    try:
        ...
        # Run sentiment and emotion analysis
        sentiment_result = service.analyze_sentiment(last_ai_message)
        emotion_result = service.analyze_emotion(last_ai_message)
