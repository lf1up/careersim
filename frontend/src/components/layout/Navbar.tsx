    ...
    <nav className="bg-retro-paper border-b-2 border-black shadow-retro-y-4 relative z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden sm:flex sm:items-center">
            <div className="flex items-center space-x-4">
              <span className="text-sm font-monoRetro">
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      {user?.email && (
                        <p className="text-sm font-monoRetro text-secondary-700">{user.email}</p>
                      )}
                    </div>
                  </div>
      ...
      {isMobileMenuOpen && (
        <div id="mobile-menu" className="sm:hidden relative z-50">
          <div className="pt-2 pb-3 space-y-1 bg-retro-paper border-t-2 border-black">
